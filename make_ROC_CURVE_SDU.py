...
score_path1='Output/SDU_A/foreer/3real_SDU_B_ODE_shift_ver2.csv'
score_path2='Output/SDU_B/foreer/3real_SDU_A_ODE_shift_ver2.csv'

s2_path1='Output/SDU_A/foreer/3real_SNDCR_SDU_B_shift_ver3.csv'
s2_path2='Output/SDU_B/foreer/3real_SDU_A_SN_DCR_shift_ver2.csv'

s3_path1='Output/SDU_A/foreer/3real_Utrans_SDU_B_shift_ver2.csv'
s3_path2='Output/SDU_B/foreer/3real_Utrans_SDU_A_shift_ver2.csv'

s4_path1='Output/SDU_A/foreer/3real_QUERY_OTR_SDU_B_shift_ver2.csv'
s4_path2='Output/SDU_B/foreer/3real_QUERY_OTR_SDU_A_shift_ver2.csv'

s5_path1='Output/SDU_A/foreer/3real_CUT_SDU_B_shift_ver2.csv'
s5_path2='Output/SDU_B/foreer/3real_SDU_A_CUT_shift_ver2.csv'

s6_path1='Output/SDU_A/foreer/3real_HARMO_SDU_B_shift_ver2.csv'
s6_path2='Output/SDU_B/foreer/3real_HARMO_SDU_A_shift_ver2.csv'

s7_path1='Output/SDU_A/foreer/3real_P2PHD_SDU_B_shift_ver2.csv'
s7_path2='Output/SDU_B/foreer/3real_P2PHD_SDU_A_shift_ver2.csv'

s8_path1='Output/SDU_A/foreer/3real_SDU_B_cyc_shift_ver2.csv'
s8_path2='Output/SDU_B/foreer/3real_SDU_A_cyc_shift_ver2.csv'

s9_path1='Output/SDU_A/foreer/3real_SDU_B_p2p_shift_ver2.csv'
s9_path2='Output/SDU_B/foreer/3real_SDU_A_p2p_shift_ver2.csv'

s10_path1='Output/SDU_A/foreer/3real_SDU_B_Proposed_380_shift_ver2.csv'
s10_path2='Output/SDU_B/foreer/3real_SDU_A_Proposed_440_shift_ver2.csv'
...
plt.savefig('EER_SDU_COMPARE.png')
