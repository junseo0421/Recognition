...
args.csvpath = 'Datasets/DS_TEST_bad(A)/'
args.origin_path = 'Datasets/images/t1_kj/'
args.test_path = 'Datasets/images/SNDCR_HKPU_A_shift_ver2/'
args.savepath = 'Output/HKPU_A/foreer/'
