...
# 하나씩 불러서 평균으로 계산
epoch = 390
score_path1 = f'D:/DION4FR/mask_change/output/HKdb-2/foreer/epoch_{epoch}/3test.csv'
...
print(EER)
with open(f'D:/DION4FR/mask_change/output/HKdb-2/foreer/epoch_{epoch}/3test_test_result_EER.txt', 'a+') as result:
